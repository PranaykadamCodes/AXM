          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
              <Button variant="ghost" asChild className="flex-shrink-0">
                <Link href="/dashboard/emp/profile" className="flex items-center space-x-1 sm:space-x-2">
              ...
              <div className="flex items-center space-x-2 min-w-0">
                <Lock className="h-6 w-6 sm:h-8 sm:w-8 text-indigo-600 dark:text-indigo-400 flex-shrink-0" />
